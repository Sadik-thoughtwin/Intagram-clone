    ...
    return (
        <Container>
            ...
            <img src="/images/aa.png" alt="" />
                <h1 className='homelogo'> Instagram</h1>
                <div>
                    <Join>Join Now</Join>
            ...
            <Section>
                <Hero>
                    ...
                    <h1>Welcome to <span className='welcome'>Instagram</span></h1>
                    <img className='langingpage' src="/images/Instagram_Langing_Page.png" alt="dsc" />
                </Hero>
                <Form>
